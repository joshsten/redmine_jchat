...
I plan on adding:
	Group,project, and role options in a configuration panel
	...
	Option to set how many recent messsages are displayed.

Fixes needed:
The auto scrolling with new messages is a little off
